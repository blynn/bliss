...
if(NULL!=o->_item/*4*/)Xgc_mark30((T0*)(o->_item/*4*/));
o=(void*)o->_next;
if((o!=NULL)&&(((gc41*)o)->header.flag==FSOH_UNMARKED))goto begin;
}
}
}
...
if(NULL!=o->_os/*4*/)gc_mark89((T89*)(o->_os/*4*/));
}}
...
if(NULL!=o->_selection/*22*/)Xgc_mark30((T0*)(o->_selection/*22*/));
}}
...
if(NULL!=o->_item/*4*/)Xgc_mark30((T0*)(o->_item/*4*/));
o=(void*)o->_next;
if((o!=NULL)&&(((gc45*)o)->header.flag==FSOH_UNMARKED))goto begin;
}
}
}
...
if(NULL!=o->_current_window/*44*/)Xgc_mark27((T0*)(o->_current_window/*44*/));
if(NULL!=o->_last_event/*40*/)gc_mark22((T22*)(o->_last_event/*40*/));
if(NULL!=o->_vis/*28*/)Xgc_mark118((T0*)(o->_vis/*28*/));
if(NULL!=o->_vis_snap/*24*/)Xgc_mark118((T0*)(o->_vis_snap/*24*/));
if(NULL!=o->_modal/*20*/)Xgc_mark27((T0*)(o->_modal/*20*/));
...
if(NULL!=o->_machine/*44*/)Xgc_mark30((T0*)(o->_machine/*44*/));
}}
...
if(((gc28*)o)->header.flag==FSOH_UNMARKED){
((gc28*)o)->header.flag=FSOH_MARKED;
if(NULL!=o->_machine_topo_order/*69*/)gc_mark39((T39*)(o->_machine_topo_order/*69*/));
...
if(NULL!=o->_machine_zorder/*17*/)gc_mark39((T39*)(o->_machine_zorder/*17*/));
if(NULL!=o->_machine_list/*13*/)gc_mark39((T39*)(o->_machine_list/*13*/));
if(NULL!=o->_machine_table/*9*/)gc_mark43((T43*)(o->_machine_table/*9*/));
if(NULL!=o->_master/*4*/)Xgc_mark30((T0*)(o->_master/*4*/));
}}
...
if(NULL!=o->_machine/*12*/)Xgc_mark30((T0*)(o->_machine/*12*/));
...
size=(size*sizeof(T0*))+sizeof(rsoh);
if((size%sizeof(double))!=0)size+=(sizeof(double)-(size%sizeof(double)));
if (size<=(na_env46.store_left)){
rsoh*r=na_env46.store;
na_env46.store_left-=size;
if(na_env46.store_left>sizeof(rsoh)){
r->header.size=size;
na_env46.store=((rsoh*)(((char*)(na_env46.store))+size));
}
else {
r->header.size=size+na_env46.store_left;
...
return((T46)new_na(&na_env46,size));
}
...
flt->header.next=gc_free88;
gc_free88=flh.header.next;
}
}
}
...
if(NULL!=o->_current_link/*8*/)gc_mark41((T41*)(o->_current_link/*8*/));
...
if(NULL!=o->_mem_lnk/*20*/)gc_mark41((T41*)(o->_mem_lnk/*20*/));
if(NULL!=o->_last_link/*12*/)gc_mark41((T41*)(o->_last_link/*12*/));
if(NULL!=o->_first_link/*8*/)gc_mark41((T41*)(o->_first_link/*8*/));
}}
...
if(NULL!=o->_machine/*4*/)Xgc_mark30((T0*)(o->_machine/*4*/));
}}
...
{Tid id=((T0*)C)->id;
if(id<=39){
R=(/*(IRF4.3count*/(/*RF2*/(((T39*)C))->_upper/*4*/)/*)*/);
}
else{
R=(r134count(((T134*)C)));
}}
